        ...
        try:
            ...
            if mode == 'analyze':
                prompt = (
                    ...
                    '2. Subject is mid-speech — describe the pace (fast, slow, measured) and energy (direct, warm, urgent, etc.)\n'
                    '3. Body movement: naturally leans in toward the camera and pulls back as he speaks, '
                    'upper body shifting with conviction. Head bobs naturally with the rhythm of speech.\n'
                    '4. Hands: "His hands drift in and out of frame as he speaks — open palms, natural expressive movement." '
                    'NEVER mention pointing, finger gestures, or any specific directed gesture.\n'
                    '5. Eyes: stay locked on the lens throughout.\n'
                    '6. Expressions: describe the emotional range fluidly — never settling. '
                    'ALWAYS include: "No overly exaggerated eye, eyebrow, or mouth movement."\n'
                    '7. Camera: "The camera is handheld with a barely perceptible natural drift — no stabilization, no zoom."\n'
                    '8. Atmosphere: one sentence on the overall energy and mood.\n'
                    '9. Background: "Lived-in background stays slightly out of focus."\n'
                    '10. Always end with: "No music. No cuts. Natural motion, candid, recorded on an iPhone 11." '
