        ...
        try:
            ...
            if mode == 'analyze':
                prompt = (
                    ...
                    '1. Start with the **camera POV type** — e.g. "Point of view webcam.", '
                    '"Selfie-style handheld POV.", "Slightly tilted handheld POV.", "Eye-level talking-head." — '
                    'infer this from how the video was actually shot.\n'
                    '2. Describe the **subject generically** — do not describe the actual person in the video. '
                    'Instead write a loose avatar-ready description: approximate age range, general ethnicity feel, '
                    'gender, and that they are talking directly to camera. e.g. '
                    '"A unique-looking woman in her late 20s talking directly to the camera."\n'
                    '3. Describe the **setting** — room type, country/region vibe if apparent, time of day.\n'
                    '4. Add: "There is at least one vibrant color prop." (always include this)\n'
                    '5. Add: "Match the camera angle, the exact camera setup and angle as the reference image."\n'
                    '6. Add: "Make the person look completely different, though."\n'
                    '7. Add any **specific exclusions** observed — e.g. "No tattoos visible.", '
                    '"No text or icons on screen.", "No busy background distractions."\n'
                    '8. End with the **inferred camera device** — e.g. "Shot on iPhone 11 front camera." '
                    'or "Shot on iPhone 15 Pro, cinematic mode." — infer from image quality, grain, and framing.\n\n'
                    'Keep each prompt concise — 4 to 6 sentences total. No bullet points, no labels, no headers inside the prompt.\n\n'
