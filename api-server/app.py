        ...
        try:
            ...
            if mode == 'analyze':
                prompt = (
                    ...
                    '3. Describe the **setting loosely and differently** — most of these videos are filmed in someone\'s home, '
                    'a corner of their home, or a home office. Identify the general type of space from the video '
                    '(home, home office, gym, outdoors, etc.) but then instruct the AI to use a COMPLETELY DIFFERENT '
                    'background — not the one in the reference. Give only the vibe/type, no specific details. '
                    'Always include: "Use a completely different background from the reference image — '
                    'a different [home setting / home office / room] with its own distinct look and feel." '
                    'Do NOT describe the actual background visible in the video. Leave full creative room.\n'
                    ...
                    'These prompts animate the still image above into a short video clip. '
                    'Write each as one clean paragraph — no bullet points, no labels. '
                    'Follow these rules:\n\n'
                    '- **DO NOT choreograph exact gesture sequences.** Describe gestures loosely and generically — '
                    'e.g. "hands drift in and out of frame as he speaks", "occasionally gestures with an open palm", '
                    '"points naturally toward the camera at moments of emphasis." Never say "at 0:05 he does X."\n'
                    '- **Body movement**: describe how the person naturally moves while speaking — '
                    'leans in toward the camera and pulls back, shifts weight, head bobs with speech rhythm, etc.\n'
                    '- **Facial expressions**: describe the emotional range fluidly — '
                    'ALWAYS include: "No overly exaggerated eye, eyebrow, or mouth movement."\n'
                    '- **Pace**: match the vocal energy from the analysis — '
                    'if the speaker was fast-paced and urgent, say so explicitly.\n'
                    '- **Camera**: handheld with barely perceptible natural drift unless original was stabilized. '
                    'No zoom, no cuts.\n'
                    '- **Atmosphere**: the overall mood — confrontational, warm, casual, urgent, authoritative, etc.\n'
                    '- **Always end with**: "Photorealistic, natural motion, candid, no jump cuts, '
                    'recorded on an iPhone 11." (or the inferred device from the text-to-image prompt above)\n\n'
