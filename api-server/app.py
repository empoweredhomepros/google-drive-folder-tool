        ...
        try:
            ...
            if mode == 'analyze':
                prompt = (
                    ...
                    '"Selfie-style POV, slightly low angle, handheld vertical video.", '
                    '"Slightly tilted handheld POV.", "Eye-level talking-head." — '
                    ...
                    '8. Add relevant **exclusions** — always include "No text or icons on screen." '
                    'Add "No tattoos visible." if the original person had none or if skin is visible.\n'
                    '9. End with the **camera device** — CRITICAL: if the shot is selfie-style or front-facing, '
