        ...
        try:
            ...
            if mode == 'analyze':
                prompt = (
                    ...
                    'For each distinct scene or key visual moment, write a detailed text-to-image prompt '
                    'ready to paste directly into an AI image generator. '
                    'Number them Scene 1, Scene 2, etc. — no timestamps. '
                    'Each prompt MUST be written as one flowing paragraph (not a bulleted list) and include ALL of the following:\n\n'
                    '- **Subject**: skin tone, hair, clothing, body position, hand/arm gesture at that exact moment\n'
                    '- **Expression**: natural and believable — no overly exaggerated eyebrows, eyes, or mouth. '
                    'Use language like "subtle warm smile", "soft engaged eyes", "natural slight head tilt" — never theatrical\n'
                    '- **Camera angle & POV**: be exact — selfie-style POV held at arm\'s length, slightly tilted handheld, '
                    'eye-level talking-head, low-angle looking up, slight Dutch tilt, over-the-shoulder, etc.\n'
                    '- **Shot framing**: close-up, medium close-up, medium shot, etc., and what\'s visible in frame\n'
                    '- **Lighting**: precise — soft natural window light from left, ring light catchlights in eyes, '
                    'warm golden backlight, harsh direct flash, soft studio diffusion, etc. Soft or hard shadows, brightness\n'
                    '- **Background**: what\'s behind the subject, sharp or blurred bokeh, any props or environment details\n'
                    '- **End every prompt with the inferred camera**: e.g. "shot on iPhone 11 front camera, slight wide-angle lens distortion, '
                    'natural film grain" or "shot on iPhone 15 Pro, cinematic mode, shallow depth of field" — '
                    'infer from the video\'s image quality, grain, and framing\n'
                    '- **Close with visual style tags**: photorealistic, candid, vertical 9:16 format, '
                    'shallow depth of field, film grain, etc.\n\n'
